...
GRUB_CMDLINE_LINUX="loglevel=8 vconsole.keymap=us net.ifnames=0 biosdevname=0 crashkernel=1G-:512M selinux=0 plymouth.enable=0 console=ttyS0,115200n8 earlyprintk=ttyS0 rootdelay=300 ipv6.disable=1 audit=1 cgroup_enable=memory swapaccount=1 apparmor=1 security=apparmor ${grub_suffix} ${CGROUP_FIX}"
